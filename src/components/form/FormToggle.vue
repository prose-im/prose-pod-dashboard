...
#{$c} {
  ...
  #{$c}__input {
    ...
    &:checked + #{$c}__field {
      ...
      &:hover {
        background-color: darken-color($color-base-purple-normal, 8%);
        cursor: pointer;
      }

      &:active {
        background-color: darken-color($color-base-purple-normal, 14%);
      }
    }
  }
  ...
  #{$c}__field {
    ...
    &:after {
      ...
      border-radius: $toggle-height;
      display: block;
      box-shadow: 0 1px 2px 0 rgba($color-background-primary, 0.08);
    ...
    &:active {
      ...
      &:after {
        box-shadow: 0 1px 2px 0 rgba($color-background-primary, 0.1);
      }
    }
  }
